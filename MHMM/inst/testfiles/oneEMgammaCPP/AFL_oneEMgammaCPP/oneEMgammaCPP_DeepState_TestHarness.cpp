...
TEST(,){
  ...
  std::string my_xs_t = "/home/akhila/fuzzer_packages/fuzzedpackages/MHMM/inst/testfiles/oneEMgammaCPP/AFL_oneEMgammaCPP/afl_inputs/" + std::to_string(t) + "_my_xs.qs";
  qs::c_qsave(my_xs,my_xs_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "my_xs values: "<< my_xs << std::endl;
  NumericVector my_ws  = RcppDeepState_NumericVector();
  std::string my_ws_t = "/home/akhila/fuzzer_packages/fuzzedpackages/MHMM/inst/testfiles/oneEMgammaCPP/AFL_oneEMgammaCPP/afl_inputs/" + std::to_string(t) + "_my_ws.qs";
  qs::c_qsave(my_ws,my_ws_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "my_ws values: "<< my_ws << std::endl;
  IntegerVector g(1);
  g[0]  = RcppDeepState_int();
  std::string g_t = "/home/akhila/fuzzer_packages/fuzzedpackages/MHMM/inst/testfiles/oneEMgammaCPP/AFL_oneEMgammaCPP/afl_inputs/" + std::to_string(t) + "_g.qs";
  qs::c_qsave(g,g_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "g values: "<< g << std::endl;
  NumericVector val  = RcppDeepState_NumericVector();
  std::string val_t = "/home/akhila/fuzzer_packages/fuzzedpackages/MHMM/inst/testfiles/oneEMgammaCPP/AFL_oneEMgammaCPP/afl_inputs/" + std::to_string(t) + "_val.qs";
