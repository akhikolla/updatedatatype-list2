...
TEST(,){
  ...
  qs::c_qsave(bw,"/home/akhila/fuzzer_packages/fuzzedpackages/orthoDr/inst/testfiles/phd_solver/inputs/bw.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "bw values: "<< bw << std::endl;
  NumericVector rho(1);
  rho[0]  = RcppDeepState_double();
  qs::c_qsave(rho,"/home/akhila/fuzzer_packages/fuzzedpackages/orthoDr/inst/testfiles/phd_solver/inputs/rho.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "rho values: "<< rho << std::endl;
  NumericVector eta(1);
  eta[0]  = RcppDeepState_double();
  qs::c_qsave(eta,"/home/akhila/fuzzer_packages/fuzzedpackages/orthoDr/inst/testfiles/phd_solver/inputs/eta.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "eta values: "<< eta << std::endl;
  NumericVector gamma(1);
  gamma[0]  = RcppDeepState_double();
  qs::c_qsave(gamma,"/home/akhila/fuzzer_packages/fuzzedpackages/orthoDr/inst/testfiles/phd_solver/inputs/gamma.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "gamma values: "<< gamma << std::endl;
  NumericVector tau(1);
  tau[0]  = RcppDeepState_double();
  qs::c_qsave(tau,"/home/akhila/fuzzer_packages/fuzzedpackages/orthoDr/inst/testfiles/phd_solver/inputs/tau.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "tau values: "<< tau << std::endl;
  NumericVector epsilon(1);
  epsilon[0]  = RcppDeepState_double();
  qs::c_qsave(epsilon,"/home/akhila/fuzzer_packages/fuzzedpackages/orthoDr/inst/testfiles/phd_solver/inputs/epsilon.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "epsilon values: "<< epsilon << std::endl;
  NumericVector btol(1);
  btol[0]  = RcppDeepState_double();
  qs::c_qsave(btol,"/home/akhila/fuzzer_packages/fuzzedpackages/orthoDr/inst/testfiles/phd_solver/inputs/btol.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "btol values: "<< btol << std::endl;
  NumericVector ftol(1);
  ftol[0]  = RcppDeepState_double();
  qs::c_qsave(ftol,"/home/akhila/fuzzer_packages/fuzzedpackages/orthoDr/inst/testfiles/phd_solver/inputs/ftol.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "ftol values: "<< ftol << std::endl;
  NumericVector gtol(1);
  gtol[0]  = RcppDeepState_double();
  qs::c_qsave(gtol,"/home/akhila/fuzzer_packages/fuzzedpackages/orthoDr/inst/testfiles/phd_solver/inputs/gtol.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "gtol values: "<< gtol << std::endl;
  IntegerVector maxitr(1);
  maxitr[0]  = RcppDeepState_int();
  qs::c_qsave(maxitr,"/home/akhila/fuzzer_packages/fuzzedpackages/orthoDr/inst/testfiles/phd_solver/inputs/maxitr.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "maxitr values: "<< maxitr << std::endl;
  IntegerVector verbose(1);
  verbose[0]  = RcppDeepState_int();
  qs::c_qsave(verbose,"/home/akhila/fuzzer_packages/fuzzedpackages/orthoDr/inst/testfiles/phd_solver/inputs/verbose.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "verbose values: "<< verbose << std::endl;
  IntegerVector ncore(1);
  ncore[0]  = RcppDeepState_int();
  qs::c_qsave(ncore,"/home/akhila/fuzzer_packages/fuzzedpackages/orthoDr/inst/testfiles/phd_solver/inputs/ncore.qs",
		"high", "zstd", 1, 15, true, 1);
