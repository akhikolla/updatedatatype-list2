...
TEST(,){
  ...
  std::string T_t = "/home/akhila/fuzzer_packages/fuzzedpackages/MSGARCH/inst/testfiles/Decoding_HMM/AFL_Decoding_HMM/afl_inputs/" + std::to_string(t) + "_T.qs";
  qs::c_qsave(T,T_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "T values: "<< T << std::endl;
  IntegerVector K(1);
  K[0]  = RcppDeepState_int();
  std::string K_t = "/home/akhila/fuzzer_packages/fuzzedpackages/MSGARCH/inst/testfiles/Decoding_HMM/AFL_Decoding_HMM/afl_inputs/" + std::to_string(t) + "_K.qs";
  qs::c_qsave(K,K_t,
		"high", "zstd", 1, 15, true, 1);
