...
TEST(,){
  ...
  std::string bw_t = "/home/akhila/fuzzer_packages/fuzzedpackages/orthoDr/inst/testfiles/save_init/libFuzzer_save_init/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_bw.qs";
  qs::c_qsave(bw,bw_t,
  ...
  std::string ncore_t = "/home/akhila/fuzzer_packages/fuzzedpackages/orthoDr/inst/testfiles/save_init/libFuzzer_save_init/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_ncore.qs";
