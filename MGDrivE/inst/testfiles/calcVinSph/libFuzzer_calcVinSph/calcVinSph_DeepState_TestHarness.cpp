...
TEST(,){
  ...
  std::string latLongs_t = "/home/akhila/fuzzer_packages/fuzzedpackages/MGDrivE/inst/testfiles/calcVinSph/libFuzzer_calcVinSph/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_latLongs.qs";
  ...
  std::string r_t = "/home/akhila/fuzzer_packages/fuzzedpackages/MGDrivE/inst/testfiles/calcVinSph/libFuzzer_calcVinSph/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_r.qs";
  qs::c_qsave(r,r_t,
		"high", "zstd", 1, 15, true, 1);
