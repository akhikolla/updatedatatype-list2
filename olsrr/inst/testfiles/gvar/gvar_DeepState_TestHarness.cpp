...
TEST(,){
  ...
  qs::c_qsave(ln,"/home/akhila/fuzzer_packages/fuzzedpackages/olsrr/inst/testfiles/gvar/inputs/ln.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "ln values: "<< ln << std::endl;
  NumericVector ly  = RcppDeepState_NumericVector();
  qs::c_qsave(ly,"/home/akhila/fuzzer_packages/fuzzedpackages/olsrr/inst/testfiles/gvar/inputs/ly.qs",
		"high", "zstd", 1, 15, true, 1);
