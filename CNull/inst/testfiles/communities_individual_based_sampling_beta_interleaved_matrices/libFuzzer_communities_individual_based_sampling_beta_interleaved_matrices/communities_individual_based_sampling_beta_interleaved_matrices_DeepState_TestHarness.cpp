...
TEST(,){
  ...
  std::string in_m_t = "/home/akhila/fuzzer_packages/fuzzedpackages/CNull/inst/testfiles/communities_individual_based_sampling_beta_interleaved_matrices/libFuzzer_communities_individual_based_sampling_beta_interleaved_matrices/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_in_m.qs";
  ...
  std::string repetitions_t = "/home/akhila/fuzzer_packages/fuzzedpackages/CNull/inst/testfiles/communities_individual_based_sampling_beta_interleaved_matrices/libFuzzer_communities_individual_based_sampling_beta_interleaved_matrices/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_repetitions.qs";
