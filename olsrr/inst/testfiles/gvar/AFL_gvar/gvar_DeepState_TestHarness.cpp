...
TEST(,){
  ...
  std::string ln_t = "/home/akhila/fuzzer_packages/fuzzedpackages/olsrr/inst/testfiles/gvar/AFL_gvar/afl_inputs/" + std::to_string(t) + "_ln.qs";
  qs::c_qsave(ln,ln_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "ln values: "<< ln << std::endl;
  NumericVector ly  = RcppDeepState_NumericVector();
  std::string ly_t = "/home/akhila/fuzzer_packages/fuzzedpackages/olsrr/inst/testfiles/gvar/AFL_gvar/afl_inputs/" + std::to_string(t) + "_ly.qs";
  qs::c_qsave(ly,ly_t,
		"high", "zstd", 1, 15, true, 1);
