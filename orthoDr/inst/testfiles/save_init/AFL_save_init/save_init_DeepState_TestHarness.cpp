...
TEST(,){
  ...
  std::string bw_t = "/home/akhila/fuzzer_packages/fuzzedpackages/orthoDr/inst/testfiles/save_init/AFL_save_init/afl_inputs/" + std::to_string(t) + "_bw.qs";
  qs::c_qsave(bw,bw_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "bw values: "<< bw << std::endl;
  IntegerVector ncore(1);
  ncore[0]  = RcppDeepState_int();
  std::string ncore_t = "/home/akhila/fuzzer_packages/fuzzedpackages/orthoDr/inst/testfiles/save_init/AFL_save_init/afl_inputs/" + std::to_string(t) + "_ncore.qs";
